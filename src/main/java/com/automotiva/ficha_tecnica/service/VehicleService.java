...
//
//import com.automotiva.ficha_tecnica.entity.*;
//import com.automotiva.ficha_tecnica.repository.*;
...
//            String nome = StringNormalizer.normalize(e.getAtributo().getNome());
...
//
//        List<String> atributos = v1.atributos()
//                .stream()
...
//
//            linha.put(v1.modelo(), r1.especificacoes().get(atributo));
//            linha.put(v2.modelo(), r2.especificacoes().get(atributo));
//
...
//    // ======================================================
//    @Transactional
//    public VehicleCrudResponse criar(VehicleCreateRequest request) {
//
...
//
//        for (Map.Entry<String, String> entry : request.especificacoes().entrySet()) {
//
//            String nome = StringNormalizer.normalize(entry.getKey());
//
//            Atributo atributo = (Atributo) atributoRepository
//                    .findByNomeIgnoreCase(nome)
//                    .orElseThrow(() ->
//                            new RuntimeException("Atributo não encontrado: " + nome)
//                    );
//
//            Especificacao espec = Especificacao.builder()
//                    .vehicle(vehicle)
//                    .atributo(atributo)
...
//
//    // ======================================================
//    // 🔄 UPDATE VEÍCULO + SPECS (MERGE INTELIGENTE)
//    // ======================================================
//    @Transactional
...
//
//        Map<String, Especificacao> mapa = new HashMap<>();
//
//        for (Especificacao e : existentes) {
//            mapa.put(e.getAtributo().getNome().toLowerCase(), e);
//        }
//
//        for (Map.Entry<String, String> entry : request.especificacoes().entrySet()) {
//
...
//
//            Especificacao existente = mapa.get(nome);
//
//            if (existente != null) {
...
//                        .build();
//
//                especificacaoRepository.save(nova);
//            }
//        }
//
//        return new VehicleCrudResponse(
